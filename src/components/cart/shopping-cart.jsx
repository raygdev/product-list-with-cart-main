                ...
                {cart.map(item => (
                    ...
                    <li className="cart-item" key={item.id}>
                        <div className="cart-item__wrapper">
                          <h3 className="cart-item__title text-4-semibold">{item.name}</h3>
                          <p className="info">
                            <span className="cart-item__quantity text-4-semibold">{item.quantity}x</span> {"  "}
                            <span className="cart-item__price text-4-regular">@ ${item.price}</span>{"  "}
                            <span className="cart-item__total text-4-semibold">${(item.price * item.quantity).toFixed(2)}</span>
                         </p>
                        </div>
                        <button
